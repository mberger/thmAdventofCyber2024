...
image: "Day23Header.png"
---

The Story

 ![Task banner for day 23](https://tryhackme-images.s3.amazonaws.com/user-uploads/5f04259cf9bf5b57aed2c476/room-content/5f04259cf9bf5b57aed2c476-1731561346191.svg)

*As time went on by, something seemed funny:*

*Mayor Malware and the source of his money!*

*SOC-mas grew closer, so The Glitch better move it.*

*Gain access to the wallet so that he could prove it!*
...
You can also access the virtual machine using SSH at the IP address `10.10.53.14` using the following credentials:
...
To learn more about cryptography, we recommend the [Cryptography](https://tryhackme.com/module/cryptography-101) module. If you want to practice more hash cracking, please consider the [John the Ripper: The Basics](https://tryhackme.com/r/room/johntheripperbasics) room.
