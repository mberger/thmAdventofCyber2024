---
 ...
 author: "Michael"
 categories: documentation tags: [documentation,AoC]
 image: Day6-logo.png
---
...
But before unleashing it to wreak havoc on SOC teams and ruin SOC-mas, there was one final step. He needed to test it [in](in) a sandbox.
